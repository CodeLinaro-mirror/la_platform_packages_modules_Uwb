...
/**
 * Defines parameters when a Radar ranging session has started.
 *
 * <p>This is passed as a bundle to the client callback {@link RangingSession.Callback#onStarted}.
 */
public class RadarRangingStartedParams extends RadarParams {
    ...
    private static final String KEY_ANTENNA_BITMAP = "antenna_bitmap";
    private static final String KEY_GPIO_BITMAP = "gpio_bitmap";
    private static final String KEY_TX_POWER = "tx_power";
    private static final String KEY_RX_GAIN = "rx_gain";
    ...
    private final int mAntennaBitmap;
    private final int mGpioBitmap;
    private final int mTxPower;
    private final int mRxGain;

    private RadarRangingStartedParams(
        ...
        mAntennaBitmap = antennaBitmap;
        mGpioBitmap = gpioBitmap;
        mTxPower = txPower;
        mRxGain = rxGain;
    ...
    public PersistableBundle toBundle() {
        ...
        bundle.putInt(KEY_ANTENNA_BITMAP, mAntennaBitmap);
        bundle.putInt(KEY_GPIO_BITMAP, mGpioBitmap);
        bundle.putInt(KEY_TX_POWER, mTxPower);
        bundle.putInt(KEY_RX_GAIN, mRxGain);
        return bundle;
    }

    /** Unpack the {@link PersistableBundle} to a {@link RadarRangingStartedParams} */
    public static RadarRangingStartedParams fromBundle(PersistableBundle bundle) {
    ...
    private static RadarRangingStartedParams parseBundleVersion1(PersistableBundle bundle) {
        return new Builder()
                ...
                .setAntennaBitmap(bundle.getInt(KEY_ANTENNA_BITMAP))
                .setGpioBitmap(bundle.getInt(KEY_GPIO_BITMAP))
                .setTxPower(bundle.getInt(KEY_TX_POWER))
                .setRxGain(bundle.getInt(KEY_RX_GAIN))
                .build();
    }
    ...
    public int getAntennaBitmap() {
        return mAntennaBitmap;
    }

    public int getGpioBitmap() {
        return mGpioBitmap;
    }
    ...
    public static final class Builder {
        ...
        private RequiredParam<Integer> mAntennaBitmap = new RequiredParam<>();
        private RequiredParam<Integer> mGpioBitmap = new RequiredParam<>();
        private RequiredParam<Integer> mTxPower = new RequiredParam<>();
        private RequiredParam<Integer> mRxGain = new RequiredParam<>();
        ...
        public Builder(@NonNull RadarRangingStartedParams params) {
            ...
            mAntennaBitmap.set(params.mAntennaBitmap);
            mGpioBitmap.set(params.mGpioBitmap);
            mTxPower.set(params.mTxPower);
            mRxGain.set(params.mRxGain);
        }
        ...
        /** Sets antenna bitmap */
        public Builder setAntennaBitmap(int antennaBitmap) {
            mAntennaBitmap.set(antennaBitmap);
            return this;
        }

        /** Sets GPIO bitmap */
        public Builder setGpioBitmap(int gpioBitmap) {
            mGpioBitmap.set(gpioBitmap);
            return this;
        }

        /** Sets TX power */
        public Builder setTxPower(int txPower) {
            mTxPower.set(txPower);
            return this;
        }

        /** Sets RX gain */
        public Builder setRxGain(int rxGain) {
            mRxGain.set(rxGain);
            return this;
        }

        /** Build {@link RadarRangingStartedParams} */
        public RadarRangingStartedParams build() {
            return new RadarRangingStartedParams(
                    mBurstPeriod.get(),
                    mSweepPeriod.get(),
                    mSweepsPerBurst.get(),
